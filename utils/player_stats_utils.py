"""
Utility functions for drawing player stats.
"""
...
def draw_player_stats(
    ...
    for index, row in player_stats.iterrows():
        ...
        player_1_name = constants.PLAYER_NAMES[1]
        player_2_name = constants.PLAYER_NAMES[2]

        text = f"     {player_1_name}     {player_2_name}"
